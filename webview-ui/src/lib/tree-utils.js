...
export function filterUncheckedNodes(nodes) {
    return nodes
...
export function formatTreeAsText(nodes, prefix = "", isRoot = true) {
...
export function checkAllChildren(nodes) {
...
export function checkAllFolders(nodes) {
    return nodes.map((node) => {
        const newNode = { ...node };
        if (node.type === "folder") {
...
export function uncheckAllChildren(nodes) {
    return nodes.map((node) => {
...
export function checkOnlyFilesAtLevel(nodes) {
    return nodes.map((node) => {
        const newNode = { ...node };
...
export function checkAllChildrenAtLevel(nodes) {
    return nodes.map((node) => {
        return { ...node, checked: true, indeterminate: false };
    });
}
